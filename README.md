...
TELG 是一个**场景化听力素材生成器**。
你描述一个你真正会遇到的场景——一次英文技术评审、一场面试、一次客户沟通、一段学生讨论。TELG 根据你描述的场景，生成一套完整的听力素材：
...
<img src="assets/screenshots/main-dark-zh.png" alt="TELG 主界面：双语对话素材" width="100%"/>
...
**任何想通过真实场景提升听力的人。** 技术只是 TELG 支持的领域之一，不是默认。职场、学生、商务、学术——都可以是素材的来源。
...
大多数听力工具让你"选一个主题"。TELG 让你**描述一个场景**。
