...
> 版本：2026-09-16 · 状态：**done（2026-09-18 refine 已实现：重写/扩写/聚焦/发散 + 改进指令，与生成面板同款双轴/时长/输出参数调节）** · 关联文档：[总体架构](../架构/architecture-总体架构.md) / [接口契约](../架构/api-contract-接口契约.md) / [需求规格](../产品/requirements-需求规格.md)
>
